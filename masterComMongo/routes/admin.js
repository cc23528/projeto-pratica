...
router.get('/funcionario', async (req, res) => {
  console.log('Rota /admin/funcionario foi acessada.');
  try {
    const funcionario = await Funcionario.find().sort({ date: 'desc' }).lean();
    console.log('Funcionários encontrados:', funcionario);
  ...
  console.log('Final da execução da rota /admin/funcionario.');
});
